...
My work asks how conversational agents can acquire **communicative competence** — the ability to hold a conversation the way a skilled human interlocutor would. My thesis builds this competence across two levels, then puts it to the test:
...
- **Assessment** — deploying an agent with both abilities in neurocognitive disorder screening, where older adults must make sense of an unfamiliar and complex system. I use the *gulfs of execution and evaluation* to analyze interactions with 38 older adults, and to ask where the two levels actually hold up.
